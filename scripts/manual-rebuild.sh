...
export DEBIAN_MIRROR=http://192.168.2.49/debian
...
# Fetch the resources
wget http://ci.local/job/dos-kernel-signing-keys/lastSuccessfulBuild/artifact/run-in-vm-results/signing_key.priv
wget http://ci.local/job/dos-kernel-signing-keys/lastSuccessfulBuild/artifact/run-in-vm-results/signing_key.x509
wget http://ci.local/job/dos-repository/lastSuccessfulBuild/artifact/sources.list
